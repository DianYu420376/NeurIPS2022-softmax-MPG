clear all
PG = load('data/PG_good_initialization.mat');
NPG = load('data/NPG_good_initialization.mat');
log_PG = load('data/log_barrier_PG_good_initialization.mat');
log_NPG = load('data/log_barrier_NPG_good_initialization.mat');
...
saveas(h, 'figures/r_lst_plot_good_initialization.jpg')
%%
c_PG = PG.c_lst;
c_NPG = NPG.c_lst;
...
saveas(h, 'figures/c_lst_plot_good_initialization.jpg')
...
xlabel('Iterations')
ylabel('NE gap')
saveas(h, 'figures/NE_lst_plot_good_initialization.jpg')
...
saveas(h, 'figures/g_lst_plot_good_initialization.jpg')

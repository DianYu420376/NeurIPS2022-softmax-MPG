...
figure;
plot(r_lst)
save('data/PG_good_initialization')
%% NPG
...
plot(r_lst)
%plot(log(NE_lst))
save('data/NPG_good_initialization')
%% Log barrier PG
lambda = 0.003;
...
plot(r_lst)
plot(log(NE_lst))
save('data/log_barrier_PG_good_initialization')
...
plot(r_lst)
%plot(log(NE_lst))
save('data/log_barrier_NPG_good_initialization')

...
function [ r_lst,c_lst,g_lst,NE_lst] = PG(pi, R, T, eta)
r_lst = zeros(T,1);
c_lst = zeros(T,1);
g_lst = zeros(T,1);
NE_lst = zeros(T,1);
...
function [r_lst,c_lst,g_lst,NE_lst] = NPG(pi, R, T, eta)
r_lst = zeros(T,1);
c_lst = zeros(T,1);
g_lst = zeros(T,1);
NE_lst = zeros(T,1);
...
function [r_lst,c_lst,g_lst,NE_lst] = log_barrier_PG(pi, R, T, eta, lambda)
r_lst = zeros(T,1);
c_lst = zeros(T,1);
g_lst = zeros(T,1);
NE_lst = zeros(T,1);
...
function [r_lst,c_lst,g_lst,NE_lst] = log_barrier_NPG(pi, R, T, eta, lambda)
r_lst = zeros(T,1);
c_lst = zeros(T,1);
g_lst = zeros(T,1);
NE_lst = zeros(T,1);
